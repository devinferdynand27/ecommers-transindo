                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="file"  class="form-control col-sm-12" id="banner" name="banner" placeholder="Masukan banner" accept="image/*" onchange="previewImage()">
                                        <small id="emailHelp2" class="form-text text-muted">Masukan Banner</small>
                                        <br>
                                        <img id="bannerPreview" src="" alt="Preview" style="display: none; border-radius: 10px; max-width: 100%; height: auto; margin-top: 10px;">
                                    </div>
