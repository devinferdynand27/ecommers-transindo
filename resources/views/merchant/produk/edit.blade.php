                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" value="{{$produk->name}}" class="form-control col-sm-12" name="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="id_kategori" required class="form-control" id="">
                                                ...
                                                @foreach ($kategori as $item)
                                                    <option value="{{$item->id}}" {{ $produk->id_kategori == $item->id  ? 'selected' : ''}}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="number" value="{{$produk->qty}}" class="form-control col-sm-12" name="qty"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="number" value="{{$produk->harga}}" class="form-control col-sm-12" name="harga"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi" id="editor" cols="100" rows="30" style="width: 100%">{{$produk->deskripsi}}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input  type="file" class="form-control col-sm-12" id="image"
                                                name="image" placeholder="Masukan image" accept="image/*"
                                                onchange="previewImage()">
                                            <small id="emailHelp2" class="form-text text-muted">Masukan image</small>
                                            <br>
                                            <img id="imagePreview" src="{{asset('produk/'. $produk->image)}}" alt="Preview"
                                                style=" border-radius: 10px; max-width: 100%; height: auto; margin-top: 10px;">
                                        </div>
                                    </div>
                                </div>
