              ...
              <div class="image-contain">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form action="/register-merchant" method="post"class="row g-4">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="text" class="form-control" id="contact"name="company_address" 
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn text-white w-100 justify-content-center"
                                        style="background: orange" type="submit">Log In</button>
                                </div>
                            </form>
                        </div>
                    </div>
