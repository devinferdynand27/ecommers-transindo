...
@section('content')
    @php
        ...
        $products = Produk::orderBy('created_at', 'asc')->get();
    @endphp
                    ...
                    <div class="search-box container">
                        <form action="/search" method="post">
                            ...
                            <div class="input-group">
                                <input type="text" name="search" class="form-control" placeholder="Cari Produk / Lokasi" aria-label="Example text with button addon">
